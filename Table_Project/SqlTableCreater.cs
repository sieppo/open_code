...
namespace Table_Project
{
    class SqlTableCreater
    {
		...
		#region Constructor
		public SqlTableCreater() { }
		public SqlTableCreater(SqlConnection connection) : this(connection, null) { }
		public SqlTableCreater(SqlConnection connection, SqlTransaction transaction)
		{
